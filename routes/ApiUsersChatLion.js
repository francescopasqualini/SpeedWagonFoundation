...
router.use('/chat/:idFrom/:idTo?/:idMessage?', function (req, res, next) {
...
//get a message
router.get('/chat/:idFrom/:idTo/:idMessage', function (req, res) {
...
//get a chat
router.get('/chat/:idFrom/:idTo', function (req, res) {
    const idFrom = res.locals.idFrom
    const idTo = res.locals.idTo
...
router.post('/chat/:idFrom/:idTo', function (req, res) {
    const idFrom = res.locals.idFrom
    const idTo = res.locals.idTo
    let body = req.body
...
router.post('/chat/:idFrom', function (req, res) {
    const idFrom = res.locals.idFrom
    let body = req.body
    if (body && body.content && MessageTypes.includes(body.type)) {
        let success = true
...
//delete a message
router.delete('/chat/:idFrom/:idTo/:idMessage', function (req, res) {
    const idFrom = res.locals.idFrom
    const idTo = res.locals.idTo
    const idMessage = res.locals.idMessage
...
//edit a message
router.put('/chat/:idFrom/:idTo/:idMessage', function (req, res) {
    const idFrom = res.locals.idFrom
    const idTo = res.locals.idTo
    const idMessage = res.locals.idMessage
    let body = req.body
